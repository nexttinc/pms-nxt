...
/*
<div
className="relative text-justify w-7/12 -translate-x-1/2 left-1/2"
key={index}
>
<div className="absolute flex left-1 align-middle">
  <Checkbox id="chkToDoList" className="mt-0.5" />
  <Label htmlFor="chkToDoList" className="mx-3">
    {toDoItem.text}
  </Label>
</div>
